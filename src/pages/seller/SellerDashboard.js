                ...
                <form onSubmit={handleSubmit} style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px' }}>
                  {[
                    ...
                    <input
                      ...
                      style={{ padding: '12px 16px', borderRadius: '40px', border: '1px solid #244C66', background: '#1B4332', color: '#EFF3F8', fontSize: '0.9rem', outline: 'none' }}
                    />
                  ))}
                  <select
                  ...
                  <textarea
                    ...
                    style={{ padding: '12px 16px', borderRadius: '20px', border: '1px solid #244C66', background: '#1B4332', color: '#EFF3F8', fontSize: '0.9rem', resize: 'vertical', outline: 'none' }}
                  />
                  ...
                  <div style={{ gridColumn: '1 / -1' }}>
                    <label style={{
                      ...
                      background: imagePreview ? 'transparent' : '#1B4332', position: 'relative', overflow: 'hidden'
                    }}>
                      {imagePreview
